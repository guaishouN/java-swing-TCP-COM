...
public class SerialPortManager {
	...
	public static String currentCommName = "";
	
	public static String getCurrentCommName() {
		return currentCommName;
	}
	
	public static SerialPort currentSerialPort;
	...
	public static void sendToPort(byte[] order) {
		if(currentSerialPort !=null) {
			sendToPort(currentSerialPort,order);
		}
	}
	...
	public static class SerialPortListener implements SerialPortEventListener {
		...
		public void serialEvent(SerialPortEvent serialPortEvent) {
			...
			case SerialPortEvent.BI: // 10.通讯中断
				//ShowUtils.appendln("检测到串口设备通讯中断信号！");
				break;
